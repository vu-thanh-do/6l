...
const eventApi = {
  ...
  searchEventNamePending(data) {
    const url =
      "/event/search_name?page=1&size_page=4&search=" + data + "&status=0";
    return axiosClient.get(url);
  },
  searchEventNameApproval(data) {
    const url =
      "/event/search_name?page=1&size_page=4&search=" + data + "&status=2";
    return axiosClient.get(url);
  },
  searchEventNameReject(data) {
    const url =
      "/event/search_name?page=1&size_page=4&search=" + data + "&status=1";
    return axiosClient.get(url);
  },
  getDataEmail() {
    const url = "/email";
